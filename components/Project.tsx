  ...
  return (
    <motion.div  >
      ...
      {showdetail === id && (
        ...
        <motion.div animate={{zIndex:99999}} className="absolute top-0 left-0 grid w-full h-auto p-2 text-black bg-gray-300 rounded-md dark:bg-dark-100 dark:text-white md:grid-cols-2 gap-x-12">
          {/* left */}
          <motion.div
            className="mx-4 my-4"
            variants={stragger}
          ...
          >
            ...
            <motion.div className="rounded-lg" variants={FadInup} whileHover={{boxShadow:'0px 0px 10px #fff'}}>
              <Image
                className="border-2 border-white rounded-lg w-full h-full"
                src={image_path}
                alt={name}
                width="300"
                height="150"
