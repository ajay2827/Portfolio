  ...
  return (
    ...
    <motion.div layout className="relative grid grid-cols-12 gap-4 my-3" variants={Pstragger} initial='initial' animate='animate' exit='exit'>
        {projectsa.map((p) => (
          ...
          <motion.div layout variants={PFadInup} key={p.id} className="col-span-12 p-3 bg-gray-300 rounded-lg sm:col-span-6 lg:col-span-4 dark:bg-dark-200"><Project showdetail={showdetail} setShowdetail={setShowdetail} project={p}/> </motion.div>
