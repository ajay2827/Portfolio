...
const Tstragger={
  ...
  return (
    <motion.div
      ...
      animate="animate"
      exit="exit"
      className="flex flex-col items-center justify-center w-full h-full mt-3 rounded-t-sm dark:bg-extblue-500 bg-dark-100"
    > 
      <motion.div   
       className="flex items-center justify-center">
        <h1 className="mx-3 mb-5 text-5xl font-semibold tracking-wide text-center text-green font-Dancing">Tech</h1>
        <h1 className="mb-5 text-5xl font-semibold tracking-wide text-center text-white dark:text-slate-400 font-Dancing"> i Know</h1>
      </motion.div>
